...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--lambda_sharp', type=float, default=1.0, help='weight for sharp enhancement loss')
        parser.add_argument('--lambda_foreground', type=float, default=5.0, help='weight for vgg loss')
