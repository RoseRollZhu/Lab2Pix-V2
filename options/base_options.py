...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--local_rank', type=int, default=0, help='local rank for this process')
        parser.add_argument('--master_address', type=str, default='127.0.0.1', help='the master host ip')
        parser.add_argument('--master_port', type=str, default='14785', help='the master host port')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        parser.add_argument('--model', type=str, default='pix2pix', help='which model to use')
        parser.add_argument('--opt_level', type=str, default='O0', choices=['O0', 'O1'], help='whether half-precision to use')
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='labelcomprehensive', help='selects model to use for netG')
